package com.squad.sippe.squadsippe.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.squad.sippe.squadsippe.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("TCC",
				"TCC.", "Versão 1.0",
				"https://github.com/wallisoncarmo/squad-sippe",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/squad-sippe", "wallisoncarmo01@gmail.com"),
				null, 
